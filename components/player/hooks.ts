...
import { Message, Playlist, PlaylistMessage } from '../common/Messages';
import { generatePeerJSKey, generateRoomCode } from '../common/RoomCode';

import { playlistReducer } from './reducers';

export type PlaylistDispatch = (message: PlaylistMessage) => void;
export interface RemotesState {[id: string]: Remote; }
